...
describe('하루 목표 섹션', () => {
  /**
   * 「독서」를 한 단어 붙인 이유: 공부 모드가 생기며 <b>목표가 둘</b>이 됐었고, 설정 화면은 계정 설정이지
   * 모드 화면이 아니라 여기 버튼은 독서 목표 고정이다. 공부 하루 목표는 2026-09-13 책별 「회당 시간」(홈 공부
   * 캐러셀 아래 손잡이)으로 대체됐지만, 공부 모드가 있는 한 「하루 목표」만으론 모호해 문구를 유지한다.
   */
