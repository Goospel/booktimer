...
// 휠 변환은 공부 「회당 시간」 시트와 함께 쓰려고 공용 모듈로 옮겼다 — 기본 상한(12시간)이 이 화면 그대로다.
export { combineWheel, wheelIndices };
...
/**
 * 독서 하루 목표 설정 — 신규 계정 첫 실행 유도 + 이후 변경(같은 엔드포인트).
 *
 * <p>공부 하루 목표 화면(`variant="study"`)은 2026-09-13 책별 「회당 시간」 시트(`SessionGoalSheet`)로 대체돼 걷었다.
 *
