...
> **진행**: ✅ **Phase 1a 전방 적재**(검색→Book→DB로 장르·출간일 흐름: `parse()` 매핑 + `BookSearchResult`/`Book` 필드 + V18 + 검색폼 hidden + addFromSearch, TDD) — PR #205 예정. ⏳ **Phase 1b 백필**(기존 책 ISBN으로 알라딘 ItemLookUp 채우기) 다음.
