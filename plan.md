...
> ⚠️ **2차 반려(2026-08-18)** — 「책이 약간 반투명해지고 흐릿해져 보인다」 + 「버튼 빗살무늬가 지저분하다」. 앞의 것은 **종이 결 레이어**가 범인이었다(무채색 노이즈 30% = 표지 사진 위에선 안개). 노이즈를 색이 아니라 알파로 옮겨 해결(T-191). 뒤의 것은 사선 해칭을 걷고 연한 세이지 채움으로 교체. 아래 두 항목은 그대로 유효하다.
