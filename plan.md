...
### 📸 독서 스토리 — 인스타 스토리식 24h 문장 공유 (설계 확정 ✅ 2026-07-02 — 구현 대기, 정본 [sns-design.md §13](claude-docs/sns-design.md))
...
> 신고는 기존 Report 재사용. 구현은 TDD(Red→Green)로 — 핸드오프 계획 md는 `claude-docs/plans/`.
