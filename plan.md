...
### 측정 대상 책 「고르기 · 바꾸기 · 붙이기」 개선 (R2) — 🔜 진행 중 (PR-1~5 코드 ✅ · 번들 164 테스트 푸시 · 실기기 A-9 ✅ · 스토어 스크린샷 재촬영 ✅ — 남은 것: 콘솔 스크린샷 교체 · 검수 요청 · [출시하기](사용자))
...
- ⬜ **남은 것** — 콘솔 스크린샷 교체(04·10) → 검수 요청(비게임 체크리스트 대조) → [출시하기](사용자, 콘솔 웹 전용)
