...
public class FollowListService {
    ...
    public List<UserSearchResult> followers(User viewer) {
        List<User> targets = followRepository.findByFolloweeOrderByCreatedAtDesc(viewer).stream()
    ...
    public List<UserSearchResult> following(User viewer) {
        List<User> targets = followRepository.findByFollowerOrderByCreatedAtDesc(viewer).stream()
