...
/**
 * {@link EmailToken} 저장소. 검증은 해시로 조회하고(평문 미저장), <b>성공 소비 시</b> 같은 user+type의
 * 형제 토큰을 무효화하기 위해 미사용분을 조회한다. 탈퇴 정리는 {@code deleteByUser}(FK).
 */
public interface EmailTokenRepository extends JpaRepository<EmailToken, Long> {
    ...
    /** 같은 사용자·용도의 아직 안 쓴 토큰들 — 성공 소비 시 함께 무효화할 형제. */
