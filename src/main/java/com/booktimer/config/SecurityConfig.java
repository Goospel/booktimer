    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/signup", "/login", "/privacy", "/verify-email", "/password/**", "/unsubscribe", "/error", "/actuator/health", "/css/**", "/js/**", "/favicon.ico", "/manifest.json", "/icons/**", "/sw.js", "/pwa-install.js").permitAll()
