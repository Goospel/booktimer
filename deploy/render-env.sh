...
declare -A SECRET_MAP=(
  ...
  [TOSS_STUDY_GOAL_ENABLED]=BOOKTIMER_TOSS_STUDY_GOAL_ENABLED
  [TOSS_STUDY_GOAL_TEMPLATE_CODE]=BOOKTIMER_TOSS_STUDY_GOAL_TEMPLATE_CODE
  [ADMIN_LOGIN_IDS]=BOOKTIMER_ADMIN_LOGIN_IDS
  [LLM_API_KEY]=BOOKTIMER_LLM_API_KEY
  [CLAUDE_API_KEY]=BOOKTIMER_CLAUDE_API_KEY
