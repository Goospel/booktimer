...
// [제목, 힌트, 하단 CTA]. tag 힌트의 「기록에서 붙일 수 있어요」는 사실이다 — 기록 화면(사이드 레일 「독서 기록」)이
// 측정 한 건씩 붙이기·바꾸기를 연다(R2 PR-3). 옛 「나중에 정해도 괜찮아요」는 그 자리가 없던 때의 약속이었다.
const TEXT = {
    start: ['측정할 책을 고르세요', '책을 고르면 책만 바뀌어요 — 측정은 「측정 시작」을 눌러야 시작돼요.', '책 없이 측정하기'],
    tag: ['무슨 책을 읽으셨나요?', '방금 측정한 독서에 책을 연결해요. 건너뛰어도 「독서 기록」에서 붙일 수 있어요.', '책 없이 기록 · 건너뛰기'],
